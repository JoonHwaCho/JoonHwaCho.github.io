function updatePage() {
  ...
  // 오디오 정지하기
  var audios = document.getElementsByTagName("audio"); // 모든 오디오 요소를 선택
  ...
  switch (selectedValue) {
    ...
    case "option10":
      ...
      break;
    default:
      contentDiv.innerHTML = "선택하신 작가가 없습니다.";
  }
}

var option1_text = `<h2>나의 뒷모습을 보고</h2>
<p>늘 주변 사람들이 말했다.<br/> 
"애고, 왜 이렇게 말랐어요?"<br/> 
...
var option2_text = `<h2>세상에서 가장 소중한<br/>나를 소개합니다</h2>
...
var option3_text = `<h2>나의 회사 생활과 개인 생활</h2> 
...
두 손 모아 <strong>기도</strong>해본다.</p>`;

var option5_text = `<h2>시계와 시간</h2> 
<p>나는 손목시계를 좋아한다. <br/> 
...
var option8_text = `<h2>오늘 바라는 내, 일</h2> 
...
그래도 웃어야 행복한 순간이 올 것이라 믿는다.</p>`;

var option9_text = `<h2>내 눈에 보이지 않는 것</h2> 
<p>우린 항상 앞만 본다네<br/> 
아무리 높은 산이 있다 해도<br/>
저 너머가 바다로 덮여 있어도<br/> 
우리는 항상 앞만 본다네 <br/> 
...
든든한 그 모습을 모두의 눈에 보이게 하라</p>`;

var option10_text = `<h2>강 팀장의 이중생활</h2> 
